...
/* The guide files live in the same Blob store as the plan (just under their
   ...
   keys. Two formats: the PDF (opened in a new tab, browser's native
   viewer) and an EPUB (this app only stores it — reading it happens in a
   separate, dedicated reader app, linked to with this file's URL, rather
   than rendering EPUBs in here too). */
const GUIDE_FILES = {
