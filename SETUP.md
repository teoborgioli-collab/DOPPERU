...
- **Description** — the line under the name. It starts with a sensible note
  about the place and is yours to rewrite: *"Birding + Höhentraining. Salinas &
  Mejía."* It grows as you type.
- **Activities** — one row each. Every field stays editable afterwards:
  ...
  - the **link** and the **note**, on the line underneath. Type a link without
    `https://` and it is completed when you click away.
